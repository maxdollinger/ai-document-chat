      ...
      {isPending && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-background/80 backdrop-blur-sm">
          <div className="flex flex-col items-center gap-4">
            ...
            <p className="text-lg font-medium text-primary-foreground text-center max-w-xs">
              {message || "Wir richten Ihren Chat-Assistenten ein und verarbeiten Ihre Dokumente. Das kann einen Moment dauern..."}
            </p>
          </div>
        </div>
      )}
